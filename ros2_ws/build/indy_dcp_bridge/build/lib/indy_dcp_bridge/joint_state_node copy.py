...
# ==== 让 Python 能找到 indydcp_example/indy_utils ====
# 假设 indydcp_example 就在 ~/JNU/connectstudy/ 下
BASE_DIR = os.path.expanduser('~/JNU/connectstudy')
INDY_UTILS_DIR = os.path.join(BASE_DIR, 'indydcp_example', 'indy_utils')
if INDY_UTILS_DIR not in sys.path:
    sys.path.append(INDY_UTILS_DIR)

from indydcp_client import IndyDCPClient   # 复用你验证过的 DCP 客户端
